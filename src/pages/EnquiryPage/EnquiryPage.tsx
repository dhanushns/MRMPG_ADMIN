...
const EnquiryPage = (): React.ReactElement => {
    ...
    const fetchEnquiryCards = useCallback(async () => {
        ...
        try {
            ...
            notification.showError('Error fetching enquiry cards', "Check your network connection", 5000);
            setCards([]);
        } finally {
    ...
    const fetchFilters = useCallback(async () => {
        ...
        try {
            ...
            notification.showError('Error fetching filters', "Check your network connection", 5000);
        } finally {
    ...
    const fetchEnquiryData = useCallback(async (page: number, filterParams: FilterValues, sortKey: string | null = null, sortDirection: "asc" | "desc" = "asc") => {
        ...
        try {
            ...
            notification.showError('Error fetching enquiry data', "Check your network connection", 5000);
            setEnquiryData([]);
            setTotalPages(1);
            setTotalEnquiries(0);
        } finally {
    ...
    // Filter handlers
    const handleFilterChange = (id: string, value: string | string[] | number | boolean | Date | { start: string; end: string } | null) => {
    ...
    const handleApplyFilters = () => {
        setCurrentPage(1);
        fetchEnquiryData(1, filterValues, sortState.key, sortState.direction);
    };
    ...
    const handleResolveEnquiry = async (enquiryId: string) => {
        try {
            ...
            notification.showError('Error resolving enquiry', 'Check your network connection and try again.', 5000);
        }
    };
    ...
    const handleDeleteEnquiry = async (enquiryId: string, enquiryName: string) => {
        ...
        try {
            ...
            notification.showError('Error deleting enquiry', 'Check your network connection and try again.', 5000);
        }
    };
