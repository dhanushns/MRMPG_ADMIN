    ...
    const validateForm = () => {
        ...
        if (!formData.capacity.trim()) {
            ...
            if (capacity < 1) {
                ...
                errors.capacity = 'Capacity cannot exceed 6 members';
                isValid = false;
            }
        }
        ...
        if (!formData.rent.trim()) {
            ...
            isValid = false;
        } else if (isNaN(Number(formData.rent))) {
            ...
            if (rent <= 0) {
                ...
                errors.rent = 'Rent amount seems too high (max ₹1,00,000)';
                isValid = false;
            }
        }
                    ...
                    <div className="form-section">
                        <div className="form-grid">
                            ...
                            <div className="form-group">
                                ...
                                <span className="field-note">Maximum 6 members per room</span>
                            </div>

                            <div className="form-group">
                                <ui.Label htmlFor="rent" required>Monthly Rent</ui.Label>
                                <div className="input-with-icon">
                                    <ui.Icons name="indianRupee" size={16} className="input-icon" />
                                    <ui.Input
                                        id="rent"
                                        type="number"
                                        value={formData.rent}
